...
- **Codebase search** — prefer `teammate({ agent: "explorer", tasks: [{ prompt: "FIND: <analysis target> SCOPE: src/ EXPECTED: file:line evidence" }] })` over raw Grep for gathering multi-file evidence across dimensions
